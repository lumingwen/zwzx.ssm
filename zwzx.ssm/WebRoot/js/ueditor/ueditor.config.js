...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"../../resAttachmentController/addEditorImage.do"             //图片上传提交地址
        ,imagePath:URL+"../../resAttachmentController/viewImage.do?"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'emotion', 'scrawl', 'map', 'gmap', 'insertframe','insertcode', 'webapp', 'pagebreak', 'template', '|',
