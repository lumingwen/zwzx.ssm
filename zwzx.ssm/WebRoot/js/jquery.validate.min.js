(function(c) {
	...
	c.extend(c.validator, {
		...
		messages : {
			...
			maxlength : c.validator.format("请输入长度最多 {0} 个字符"),
			minlength : c.validator.format("请输入长度最少 {0} 个字符"),
			rangelength : c.validator.format("请输入长度要在{0} 到 {1} 之间"),
			range : c.validator.format("请输入一个介于 {0} 到 {1}之间的值."),
			max : c.validator.format("请输入一个最大为 {0}."),
			min : c.validator.format("请输入一个最小为 {0}.")
//			phone: '请填写正确的电话号码',
//			mobile: '请填写正确的手机号码',
//			ip: '请填写正确的IP地址',
//			idcard: '请填写正确的身份证号码'
...
//			ip:function(a,b){
//				return this.optional(b) || /^((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){3}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})$/i.test(a)
//			},
//			phone:function(a,b){
//				return this.optional(b) || /[0-9-()（）]{7,18}/.test(a)
//			},
//			mobile:function(a,b){
//				return this.optional(b) || /0?(13|14|15|18)[0-9]{9}/.test(a)
//			},
//			idcard:function(a,b){
//				return this.Optioal(b) || /\d{17}[\d|x]|\d{15}/.test(a);
//			}
		}
	});
