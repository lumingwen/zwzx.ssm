...
<%@ page import="com.shili.lu.rms.dto.*" %>
<html>
<head>
<title>管理页面</title>
...
<table width="100%" height="64" border="0" cellpadding="0" cellspacing="0" class="admin_topbg">
  <tr>
    ...
    <td width="39%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <% 
      SessionUserDto Pname =null;
				  Pname=(SessionUserDto)session.getAttribute("loginUser");
      %>
        <td width="74%" height="38" class="admin_txt">管理员：<b><%=Pname.getName() %></b> 您好,感谢登陆使用！</td>
